...
export const Appointment = async (req, res) => {
    try {
        ...
        const { userid, email, patientName, date, bookedSlot, consultingDoctor,patientAge,mobileNumber } = patientData;
console.log("my appointments", patientData)
...
// if (appointmentDateTime < now && appointment.appointmentStatus !== 'Completed') {
...
// }
        ...
        const completeAppointmentData = {
            ...patientData,
    patientAge: Number(patientAge),   // give it a key
...
console.log("complete appointments", completeAppointmentData)
